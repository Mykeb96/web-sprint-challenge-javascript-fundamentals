...
// internal is still within the scope of the function that it is in.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    for (var i = 0; i < array.length; i++){
      testing.push(`name: ${array[i].animal_name}, scientific: ${array[i].scientific_name}`);
    }
  ...
  */
  ...
  function lowerCaseNames(array){
    ...
    idk = array.map(x => x.animal_name.toLowerCase());
  ...
  */
  ...
  function lowPopulationAnimals(array){
    var idk = array.filter(x => x.population < 5)
  ...
  */
  ...
  function USApop(array){
    ...
    var allPopulations = [];
    for (var i = 0; i < array.length; i++){
      allPopulations.push(array[i].population);
    }

    var totalPopulation = allPopulations.reduce(reducer);
...
var cuboidTwo = new CuboidMakerTwo(4, 5, 5);
